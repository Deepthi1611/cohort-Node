...
// pgclient.query is used to execute SQL queries
// pgclient.query returns a promise
// we can use await to wait for the promise to resolve
// const res = await pgClient.query('SELECT NOW()');
// console.log(res.rows); // print the result rows
